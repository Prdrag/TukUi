...
local bsize = ((TukuiMinimap:GetHeight()) / 6)

local raidbuff_reminder = CreateFrame('Frame', 'RaidBuffReminder', Minimap)
raidbuff_reminder:Width(RBRWidth)
raidbuff_reminder:Point('TOPLEFT', TukuiMinimap, 'TOPRIGHT', 4, 2)
raidbuff_reminder:Point('BOTTOMLEFT', TukuiMinimap, 'BOTTOMRIGHT', 4, -2)
